        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    {/*<img src="http://localhost:8080/uploads/hotel.png" alt="Empire Hotel" className="header-image" />*/}
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Empire Hotel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Empire Hotel</span></h2>

            {/* SERVICES SECTION */}
            <section className="service-section"><div className="service-card">
                <img src="http://localhost:8080/uploads/ac.png" alt="Air Conditioning" />
                ...
                <div className="service-card">
                    <img src="http://localhost:8080/uploads/mini-bar.png" alt="Mini Bar" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src="http://localhost:8080/uploads/parking.png" alt="Parking" />
                    <div className="service-details">
                ...
                <div className="service-card">
                    <img src="http://localhost:8080/uploads/wifi.png" alt="WiFi" />
                    <div className="service-details">
